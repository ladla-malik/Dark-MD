const {
  ...
  const ownerNumber = ['923435611415']
...
const sessdata = config.SESSION_ID.replace("Dark-MD~", '');
...
const port = process.env.PORT || 9090;
  ...
  let up = `*𝐇𝐞𝐥𝐥𝐨 𝐝𝐞𝐚𝐫 𝐃𝐚𝐫𝐤-𝐌𝐃 𝐔𝐬𝐞𝐫! \ud83d\udc4b\ud83c\udffb* \n\n> Simple , Straight Forward But Loaded With Features \ud83c\udf8a, Meet Dark-MD WhatsApp Bot.\n\n *𝐓𝐡𝐚𝐧𝐤𝐬 𝐟𝐨𝐫 𝐮𝐬𝐢𝐧𝐠 𝐃𝐚𝐫𝐤-𝐌𝐃🚩 \ud83d\udea9* \n\n> Join WhatsApp Channel :- ⤵️\n \nhttps://whatsapp.com/channel/0029VajDW8fL2ATvFiFt4l1e\n\n- *YOUR PREFIX:* = ${prefix}\n\nDont forget to give star to repo ⬇️\n\nhttps://github.com/ladla-malik/DARK-MD\n\n> © Powered BY Dark Team \ud83d\udda4`;
    conn.sendMessage(conn.user.id, { image: { url: `https://i.ibb.co/Kx86CSc4/3676.jpg` }, caption: up })
  }
  })
  ...
  if (mek.key && mek.key.remoteJid === 'status@broadcast' && config.AUTO_STATUS_REACT === "true"){
    const darklike = await conn.decodeJid(conn.user.id);
    const emojis = ['❤️', '💸', '😇', '🍂', '💥', '💯', '🔥', '💫', '💎', '💗', '🤍', '🖤', '👀', '🙌', '🙆', '🚩', '🥰', '💐', '😎', '🤎', '✅', '🫀', '🧡', '😁', '😄', '🌸', '🕊️', '🌷', '⛅', '🌟', '🗿', '🇵🇰', '💜', '💙', '🌝', '🖤', '💚'];
    ...
    }, { statusJidList: [mek.key.participant, darklike] });
  }                       
  ...
  const udp = botNumber.split('@')[0];
    const Ladla = ('923435611415', '923705807807', '923235544788');
    let isCreator = [udp, Ladla, config.DEV]
 ...
 //================ownerreact==============
  ...
  if(senderNumber.includes("923435611415")){
  if(isReact) return
  m.react("🦋")
   }
  //==========public react============//
